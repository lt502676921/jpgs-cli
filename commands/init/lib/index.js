...
const { spinnerStart, sleep, execAsync } = require('@jpgs-cli-dev/utils')
...
class InitCommand extends Command {
  ...
  async downloadTemplate() {
    ...
    const targetPath = path.resolve(userHome, '.jpgs-cli-dev', 'template')
    const storeDir = path.resolve(userHome, '.jpgs-cli-dev', 'template', 'node_modules')
  ...
  async createComponentFile(targetPath) {
    ...
    if (templateInfo.tag.includes(TYPE_COMPONENT)) {
      const componentData = {
        ...projectInfo,
        buildPath: templateInfo.buildPath || 'dist',
        examplePath: templateInfo.examplePath || 'examples',
